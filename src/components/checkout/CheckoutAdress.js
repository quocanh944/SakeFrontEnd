        ...
        <div>
            ...
            <form action='' method='post' className='flex flex-col gap-[10px] mb-[30px]'>
                <div className='flex gap-2'>
                    <input type='text' placeholder='First Name' name='fisrtname' className='pl-4 py-3 border basis-6/12 h-10 bg-backgroundprimary' />
                    <input type='text' placeholder='Last Name' name='lastname' className='pl-4 py-3 border basis-6/12 h-10 bg-backgroundprimary' />
                </div>
                <div>
                    <input type='text' placeholder='Address' name='address' className='pl-4 py-3 border basis-6/12 h-10 bg-backgroundprimary w-full' />
                </div>
                <div>
                ...
                <div className='flex gap-2'>
                    ...
                    <input type="tel" name="telephone" placeholder='Phone Number' className='pl-4 py-3 border basis-4/12 h-10 bg-backgroundprimary w-full'/>
                    <input type="tel" name="zipcode" placeholder='Zipcode' className='pl-4 py-3 border basis-6/12 h-10 bg-backgroundprimary w-full'/>
                </div>
                <div>
